...
class UrlHistoriesControllerTest < ActionController::TestCase
  ...
  test "should create url_history" do
    assert_difference('UrlHistory.count') do
      post :create, url_history: { crawler_session_id: @url_history.crawler_session_id, diff_to_previous: @url_history.diff_to_previous, image_path: @url_history.image_path, url: @url_history.url }
    end
  ...
  test "should update url_history" do
    patch :update, id: @url_history, url_history: { crawler_session_id: @url_history.crawler_session_id, diff_to_previous: @url_history.diff_to_previous, image_path: @url_history.image_path, url: @url_history.url }
    assert_redirected_to url_history_path(assigns(:url_history))
  end
